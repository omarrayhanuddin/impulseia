...
import { ArrowRight, ArrowUpRight, CheckCircle, ChevronRight, Code, Database, Globe, Layers, Lock, Zap } from "lucide-react"
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-white/70">1260 Dhaka, Bangladesh</span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <span className="text-white/70">+880 1760843880</span>
              </li>
              <li className="flex items-center gap-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="text-white/70">info@impulseia.com</span>
              </li>
            </ul>
          </div>
        </div>
